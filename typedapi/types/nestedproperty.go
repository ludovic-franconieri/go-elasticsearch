...
// NestedProperty type.
//
// https://github.com/elastic/elasticsearch-specification/blob/1ad7fe36297b3a8e187b2259dedaf68a47bc236e/specification/_types/mapping/complex.ts#L39-L44
...
func (s *NestedProperty) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "include_in_parent":
			if err := dec.Decode(&s.IncludeInParent); err != nil {
				return err
			}

		case "include_in_root":
			if err := dec.Decode(&s.IncludeInRoot); err != nil {
				return err
			}
